...
<template>
    <div style="position: relative;">
        ...
        <el-dialog align="left" title="—— 编辑列表 ——" :visible="isEditing" :show-close="false" width="700px"
            ...
            <div slot="footer">
                <el-button type="warning" @click="toMove">迁出</el-button>
...
export default {
    ...
    methods: {
        ...
        // 重新获取数据
        async getData() {
            const { list, total } = await this.$api.personnelManage.checked(this.search); // 这行才是核心模拟从服务器拿数据的请求
            this.list = list;
            // 更新总数据条数
            this.total = total;
