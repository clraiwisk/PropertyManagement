<template>
    <div class="jfjl">
            ...
            <el-container>
                <el-header>
                    ...
                    <el-form-item label="支付方式：">
                        <el-select v-model="search.payType" @change="currentPage = 1" size="mini" :style="{ width: '80px', height: '25px' }">
                            <el-option label="全部" value="全部"></el-option>
        ...
        <el-table :data="list">
            <el-table-column label="流水号" sortable prop="serial" width="180"></el-table-column>
            <el-table-column label="账号编号" prop="billNumber" width="200"></el-table-column>
            <el-table-column label="所属房屋" prop="ownedHouse" align="center" width="240"></el-table-column>
            <el-table-column label="账单类目" prop="billtype" align="center" width="120"></el-table-column>
            <el-table-column label="实收金额" prop="amount" align="center" width="120"></el-table-column>
            <el-table-column label="缴费时间" prop="time" width="200" align="center"></el-table-column>
            <el-table-column label="支付方式" prop="payType" align="center"></el-table-column>
        </el-table>
...
import { mapState } from 'vuex';
    export default {
        ...
        methods: {
            async getDate() {
                const { total, list } = await this.$api.PaymentManage.getData(this.search);
                this.total = total;
                this.list = list
